...
frames_folder_parent = '/mnt/ssd2/od/datasets/20210418/frames' #'/mnt/ssd2/od/datasets/lights_vids/frames' 
#"/home/od/files/datasets/ped_dummy_vids_2021/frames"
labelled_videos_parent = "/home/lns/helen/lights-n-signs-training/labelled_videos" 
# "/home/od/files/datasets/ped_dummy_vids_2021/labelled_videos"

trainer_name = 'matthieu_darknet53_416_3' #'matthieu_darknet53_256_1'#'matthieu_darknet53_384_1' #'matthieu_darknet53_416_4'#'matthieu_darknet53_416_3' #'new_dataset_ac_small_3' #'new_dataset_ac_medium_1' #'smaller_800x640_1' #'new_dataset_ac_small_3' #'new_dataset_ac_1' # "yolo_ped_mbd_trial_29"
