...
# It saves images one by one, which takes 2min for lisa_signs but 1h30min for Y4Signs (lisa_signs has 6000 images size 500kB but Y4Signs has 14000 images size 8MB)
