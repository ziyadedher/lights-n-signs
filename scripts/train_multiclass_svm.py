...
PATH_TRAIN = '/home/od/.lns-training/resources/processed/haar/y4Signs_train_text_svm_48'
PATH_TEST = '/home/od/.lns-training/resources/processed/haar/y4Signs_test_text_svm_48'
...
def _data_path(i):
    ...
    return [
        ...
        "tiffany_text_{}_vs_rest".format(models[i])
    ]
...
def _test_joint(input_size=(48, 48)):
    ...
    for i in range(4):
        ...
        res = []
        for j in range(4):
            model_path = os.path.join(MODEL_OUTPUT_PATH, "tiffany_text_{}_vs_rest".format(models[j]))
