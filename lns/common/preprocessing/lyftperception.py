...
def _lyftperception(path: str = '/home/lns/.lns-training/resources/data/LyftPerception/train', datatype: str ='train') -> Dataset:  # noqa
    ...
    classes: Dataset.Classes = ['car', 'pedestrian', 'animal', 'other_vehicle', 'bus', 'motorcycle', 'truck', 'emergency_vehicle', 'bicycle']
    annotations: Dataset.Annotations = {}

    lyft = LyftDataset(data_path = path, #'/home/lns/.lns-training/resources/data/LyftPerception/train', 
                        json_path = os.path.join(path, datatype+'_data'), #'/home/lns/.lns-training/resources/data/LyftPerception/train/train_data', 
    ...
    for sample in lyft.sample:
        ...
        for box in boxes:
            ...
            label = box.name # car, pedestrian, animal, other_vehicle, bus, motorcycle, truck, emergency_vehicle, bicycle
            if label is not None:
                class_index = classes.index(box.name)
