...
CLIPS_DIR=/mnt/ssd6/JAADDataset/JAAD_clips  #path to the directory with mp4 videos
FRAMES_DIR=/mnt/ssd6/JAADDataset/JAAD_clips/images  #path to the directory for frames
