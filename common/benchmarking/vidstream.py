...
"""
import sys
lights_n_signs_home = "/mnt/ssd1/lns/lights-n-signs-training"
...
def test_video_stream(model) -> None:
...
def save_bounding_box_video(model, vid_path: str, out_path: str, wid: int, hgt: int):
...
if __name__ == "__main__":
    from lns_common.model.yolo import YOLO  #Won't work in general: specify path to desired model

    model = YOLO()
    save_bounding_box_video(model, "out.mp4", "bb_output.mp4", 1920, 1440)
