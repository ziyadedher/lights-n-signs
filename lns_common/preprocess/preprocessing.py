...
def preprocess_scale_signs(scale_signs_path: str, proportion: float = 1.0,
                            testset: bool = False) -> Dataset:
    """Preprocess and generate data for our custom dataset at the given path.
    ...
    if not testset:
        return set_proportions("scale_signs", {"scale_signs": images},
                               detection_classes, annotations, proportion)
    else:
        return create_testset("scale_signs", {"scale_signs": images},
                              detection_classes, annotations, proportion)
